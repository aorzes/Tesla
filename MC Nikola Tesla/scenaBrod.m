...
-(void)didMoveToView:(SKView *)view {
    ...
    SKSpriteNode *tipka1 = [SKSpriteNode spriteNodeWithImageNamed:@"leftB"];
    ...
    SKSpriteNode *tipka2 = [SKSpriteNode spriteNodeWithImageNamed:@"rightB"];
...
-(void)kretanje{
    ...
    if(brzina>0 && d>10){
        ...
        trag.size = CGSizeMake(brod.size.width*1.5, brod.size.width*1.5);
        trag.name=@"trag";
        trag.zPosition = 1;
        trag.alpha=0.1;
