...
- (void) prikazi {
    ...
    if(okviric.frame.origin.y>self.view.frame.size.height-okviric.frame.size.height)
    {
        pp.origin.y = self.view.frame.size.height-okviric.frame.size.height; okviric.frame = pp;
    }
    if(okviric.frame.origin.x>self.view.frame.size.width-okviric.frame.size.width)
    {
